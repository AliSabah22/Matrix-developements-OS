...
const PROJECTS = [
  {
    ...
    statusKey: 'green',
    description:
      'OS for high-end automotive wrap, PPF, tint, and detailing shops. Replaces GoHighLevel + TintWiz + spreadsheets with a unified platform.',
    pricing: '$200–350 / location / mo',
  ...
  },
  {
    ...
    statusKey: 'blue',
    description:
      'Custom project management and client portal for an architecture firm.',
    pricing: 'Fixed scope',
  ...
  },
  {
    ...
    statusKey: 'amber',
    description:
      'Shared infrastructure to scale the vertical SaaS model to new industries beyond automotive.',
      ...
      <header className={styles.header}>
        <div className={styles.headerLeft}>
          <svg width="28" height="28" viewBox="0 0 32 32" fill="none" aria-hidden="true">
            <rect x="2" y="6" width="16" height="16" rx="4" fill="#6c63ff" opacity="0.9" transform="rotate(-15 10 14)" />
            <rect x="14" y="10" width="16" height="16" rx="4" fill="#9d97ff" opacity="0.7" transform="rotate(-15 22 18)" />
          </svg>
          <span className={styles.logoText}>Matrix Developments</span>
        ...
        <div className={styles.headerRight}>
          ...
          <Link href="/ops" className={styles.opsButton}>Operations Panel →</Link>
        </div>
      </header>
      ...
      <div className={styles.content}>
        ...
        <section className={styles.section}>
          ...
          <div className={styles.projectGrid}>
            {PROJECTS.map((project) => (
              <div key={project.id} className={`${styles.projectCard} ${styles[`card_${project.statusKey}`]}`}>
                ...
                <div className={styles.projectMeta}>
                  <span className={styles.projectPricing}>{project.pricing}</span>
                </div>
                <div className={styles.projectAgents}>
                  ...
                  <Link href={`/agents/ceo-strategy?project=${project.id}`} className={styles.openProjectBtn}>
                    Open with Atlas →
                  </Link>
                </div>
              </div>
        ...
        <section className={styles.section}>
          <div className={styles.sectionHeader}>
            ...
            <span className={styles.sectionCount}>12 agents</span>
          </div>
          {DEPT_ORDER.map((dept) => {
